...
namespace aiHelper
{
	...
	bool saveTextureToFile(aiGraphics::Texture2D& texture, const std::string& fileName);

	bool saveTextureToFile(const std::vector<uint8_t>& textureData, const aiGraphics::TextureDesc& desc, const std::string& fileName);
