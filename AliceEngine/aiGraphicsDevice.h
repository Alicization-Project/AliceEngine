...
namespace aiGraphics
{
	...
	public:
		...
		{
			return XMMatrixOrthographicOffCenterLH(0, (float)GetScreenaidth(), (float)GetScreenHeight(), 0, -1, 1);
		}
		...
		virtual void Draaindexed(UINT indexCount, UINT startIndexLocation, UINT baseVertexLocation, GRAPHICSTHREAD threadID) = 0;
		virtual void Draainstanced(UINT vertexCount, UINT instanceCount, UINT startVertexLocation, UINT startInstanceLocation, GRAPHICSTHREAD threadID) = 0;
		virtual void DraaindexedInstanced(UINT indexCount, UINT instanceCount, UINT startIndexLocation, UINT baseVertexLocation, UINT startInstanceLocation, GRAPHICSTHREAD threadID) = 0;
		virtual void DraainstancedIndirect(const GPUBuffer* args, UINT args_offset, GRAPHICSTHREAD threadID) = 0;
		virtual void DraaindexedInstancedIndirect(const GPUBuffer* args, UINT args_offset, GRAPHICSTHREAD threadID) = 0;
